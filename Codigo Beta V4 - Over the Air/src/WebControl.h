...
String getSliderValues(){
  ...
  return jsonString; //preciso mostrar ISSO NA WEB
}
...
void initWiFi() {
  ...
  while (WiFi.status() != WL_CONNECTED) {
    //Enquanto está conectando fica piscando
    digitalWrite(2, 1);
    delay(250);
    digitalWrite(2, 0);
    delay(250);
